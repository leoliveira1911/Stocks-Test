        ...
        return data?.map((el, index) => {
            if (el[0] != "" && index > 0)
                return ( 
                    ...
                    `}>
                        <td className={`sm:hidden first:table-cell text-center px-3`} >{el[5] == '#N/A' ? 'TICKER INVÁLIDO' : `${el[0]}`}</td>
                        ...
                        <td className={`sm:hidden seventh:table-cell text-center px-3`} >{el[9] == '#N/A' ? 'TICKER INVÁLIDO' : `R$${el[9]}`}</td>
        ...
        `}>
            ...
            <table className={`rounded-xl overflow-hidden mx-4 text-center`}>
                <thead className={`bg-gray-200 dark:text-gray-200 dark:bg-gray-900  py-2`}>
                    <tr>
                        <th className={`sm:hidden first:table-cell p-3`} >Data de Compra </th>
                ...
                <tbody>
                    ...
                    <tr className={`bg-green-700 rounded-lg`}>
                        ...
                        <td className={`sm:hidden first:table-cell text-center text-lg font-bold`} ></td>
                        ...
                        <td className={`sm:hidden seventh:table-cell text-center text-lg font-bold`} >{props.values?.current}</td>
